...
BoxItem.prototype.repositionY = function() {
  ...
  if (orientation == 'top') {
    ...
    if (axisGroupId != undefined) {
      var group = this.parent.itemSet.groups[axisGroupId];

      box.style.top = (this.top || 0) + 'px';


      if (this.top + this.parent.top < group.top)
      {
        //var top = this.top + this.parent.top + this.height;
        //console.log(top);
        //line.style.height = (group.top - top ) + 'px';
